...
if [ $? -eq 0 ]; then
    ...
    echo "  • API Endpoint: http://$PI_HOST/api/"
    ...
    echo "  2. Ensure your vite.config.js proxy points to http://$PI_HOST/api"
    ...
    echo "  • Test API: curl http://$PI_HOST/api/users"
    echo "  • Test Health: curl http://$PI_HOST/health"
    echo ""
