...
if [ $? -eq 0 ]; then
    ...
    echo "  • Backend API: http://$PI_HOST:5001"
    echo "  • Health Check: http://$PI_HOST:5001/health"
    echo ""
    echo "🖥️ To develop with local frontend:"
    echo "  1. Create .env.development in your frontend:"
    echo "     VITE_API_URL=http://$PI_HOST:5001/api"
    ...
    echo "  • Test API: curl http://$PI_HOST:5001/health"
    echo ""
